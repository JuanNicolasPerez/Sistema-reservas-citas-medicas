...
class EventController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with([
            'mensaje' => 'Se elimino la reserva de manera correcta.',
            'icono' => 'success',
        ]);
    }
    ...
    public function pdf()
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('admin.reservas.pdf',
            compact(
                'configuracion',
                'eventos'
            )
    ...
    public function pdf_fechas(Request $request){
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('admin.reservas.pdf_fechas',
            compact(
                'configuracion',
                'eventos',
                'fecha_inicio',
