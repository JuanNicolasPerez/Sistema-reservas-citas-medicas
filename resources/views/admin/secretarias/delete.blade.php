...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Eliminar secretaria</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $secretaria->apellidos }}"
                                    name="apellidos" id="apellidos" disabled>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="address" class="form-control" value="{{ $secretaria->direccion }}"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" value="{{ $secretaria->user->email }}"
